...
---@param rel string Path relative to an rtp root, e.g. "scripts/elasticsearch_run/es_simulate_runner.py".
...
function M.resolve()
  ...
  cfg.script_path = M.script_path
    or rtp_file("scripts/elasticsearch_run/es_simulate_runner.py")
